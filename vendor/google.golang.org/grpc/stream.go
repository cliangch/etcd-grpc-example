...
// StreamDesc represents a streaming RPC transport's method specification.
...
type serverStream struct {
	...
	mu sync.Mutex // protects trInfo.tr after the transport handler runs.
}
...
// The returned string is in the format of "/transport/method".
