...
const (
	...
	golang      = "GO"
	// In DNS, transport config is encoded in a TXT record via the mechanism
...
func (d *dnsResolver) lookupTXT() string {
	...
	// TXT record must have "grpc_config=" attribute in order to be used as transport config.
...
func canaryingSC(js string) string {
	...
	if err != nil {
		grpclog.Warningf("grpc: failed to parse transport config json string due to %v.\n", err)
		return ""
	}
