...
// "grpc.Dial" is called to this client conn.
...
type Balancer interface {
	// Balancer is called on specified client conn. Client initiates gRPC
	// conn with "grpc.Dial(addr, grpc.WithBalancerName)", and then those resolved
